...
public class ActorDAO {
    ...
    public void insertActor(Actor actor) {
        String query = "INSERT INTO szinesz(vezeteknev, keresztnev, szuletesi_ido, nem) VALUES ('" + actor.getLastName() + "', '" + actor.getFirstName() + "', '" + actor.getDateOfBirth() + "', '" + actor.isSex() +"')";
    ...
    public void updateActor(Actor actor) {
        String query = "UPDATE szinesz SET vezeteknev'" + actor.getLastName() + "', keresztnev='" + actor.getFirstName() + "', szuletesi_ido='" + actor.getDateOfBirth() +"', nem= '" + actor.isSex() + "' WHERE szinesz_id=" + actor.getActor_id();
        DbDAO.executeUpdate(query);
    }
}
